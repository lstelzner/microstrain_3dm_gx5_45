...
void Microstrain::run() {
  ...
  if (device_setup) {
    ...
    if (enable_filter) {
      ...
      data_stream_format_descriptors[2] = MIP_FILTER_DATA_GYRO_BIAS_UNCERTAINTY;
      data_stream_format_descriptors[3] = MIP_FILTER_DATA_LINEAR_ACCELERATION;
      data_stream_format_descriptors[3] = MIP_AHRS_DATA_GYRO_SCALED;
      data_stream_format_decimation[0] = imu_decimation;  // 0x32;
      data_stream_format_decimation[1] = imu_decimation;  // 0x32;
      data_stream_format_decimation[2] = imu_decimation;  // 0x32;
      data_stream_format_num_entries = 3;
      ...
      while (mip_get_next_field(packet, &field_header, &field_data,
        ...
        switch (field_header->descriptor) {
          ...
          case MIP_FILTER_DATA_NED_VEL: {
            memcpy(&curr_filter_vel_, field_data,
          ...
          case MIP_FILTER_DATA_ATT_QUATERNION: {
            ...
            nav_msg_.pose.pose.orientation.z =
                -1.0 * curr_filter_quaternion_.q[3];
          ...
          case MIP_FILTER_DATA_POS_UNCERTAINTY: {
            ...
            // For little-endian targets, byteswap the data field
            mip_filter_llh_pos_uncertainty_byteswap(
                &curr_filter_pos_uncertainty_);
          ...
          case MIP_FILTER_DATA_VEL_UNCERTAINTY: {
            ...
            // For little-endian targets, byteswap the data field
            mip_filter_ned_vel_uncertainty_byteswap(
                &curr_filter_vel_uncertainty_);
          ...
          case MIP_FILTER_DATA_ATT_UNCERTAINTY_EULER: {
            ...
            nav_msg_.pose.covariance[35] = curr_filter_att_uncertainty_.yaw *
      ...
      while (mip_get_next_field(packet, &field_header, &field_data,
        ...
        switch (field_header->descriptor) {
          ...
          case MIP_AHRS_DATA_ACCEL_SCALED: {
            memcpy(&curr_ahrs_accel_, field_data,
          ...
          case MIP_AHRS_DATA_QUATERNION: {
            memcpy(&curr_ahrs_quaternion_, field_data,
      ...
      while (mip_get_next_field(packet, &field_header, &field_data,
        ...
        switch (field_header->descriptor) {
          ...
          case MIP_GPS_DATA_LLH_POS: {
            ...
            gps_msg_.position_covariance[0] =
                curr_llh_pos_.horizontal_accuracy *
                curr_llh_pos_.horizontal_accuracy;
            gps_msg_.position_covariance[4] =
                curr_llh_pos_.horizontal_accuracy *
                curr_llh_pos_.horizontal_accuracy;
            gps_msg_.position_covariance[8] = curr_llh_pos_.vertical_accuracy *
                                              curr_llh_pos_.vertical_accuracy;
